...
// 1. Define a common interface for both modals
interface ModalProps {
    isOpen: boolean;
    onClose: () => void;
}

// Using the common ModalProps interface
interface DownloadBrochureModalProps extends ModalProps {}
...
// --- BookDemoModal Component (NEWLY INTEGRATED) ---
...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    // Simulate form submission and successful booking
    console.log("Form Submitted for demo booking.");
    alertMessage("Thank you! Our team will contact you soon for your demo.", "success");
    onClose();
  };

  return (
    <div
      className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center p-4 z-50 backdrop-blur-sm transition-opacity duration-300"
      onClick={onClose}
    >
      <div
        className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md transform transition-all duration-300 scale-100 animate-in fade-in-0 zoom-in-95"
...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Schedule a free, personalized demo of our platform and courses.
          </p>
          <div>
            <label htmlFor="demo-name" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
              Full Name
            </label>
            <input
              type="text"
              id="demo-name"
              required
              className="w-full px-4 py-2 border border-gray-300 rounded-lg dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition"
              placeholder="Your full name"
            />
          </div>

          <div>
            <label htmlFor="demo-email" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
              Gmail
            </label>
            <input
              type="email"
...
          <div>
            <label htmlFor="demo-mobile" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
              Mobile Number
            </label>
            <input
              type="tel"
...
          <div>
            <label htmlFor="demo-course" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
...
          <button
            type="submit"
            className="w-full bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 transition font-medium shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            Schedule My Demo
          </button>
        </form>
...
    // 2. NEW STATE: State for the Book Demo Modal
...
            {/* ALERT PLACEHOLDER: Used by both modals for success messages */}
...
                            {/* 2. Book a Demo (New Secondary Solid CTA) - UPDATED: To open the new modal */}
                            <Button 
                                size="lg" 
...
                                onClick={() => setIsDemoModalOpen(true)} // Opens the new BookDemoModal
                            >
                                Book a Demo
                            </Button>
                            
