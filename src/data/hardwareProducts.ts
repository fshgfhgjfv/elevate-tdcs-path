...
export const hardwareProducts: HardwareProduct[] = [
  {
    ...
    salePrice: 2860,
    isOutOfStock: false,
    description: "Advanced USB Rubber Ducky alternative built on Raspberry Pi Pico. Perfect for penetration testing, security audits, and educational purposes. Pre-installed with custom firmware for instant deployment.",
    features: [
      "Pre-installed penetration testing firmware",
      "USB HID attack capabilities",
      "Custom payload support",
      "Compact and portable design",
      "Compatible with all major operating systems"
    ],
    specifications: [
      { label: "Processor", value: "RP2040 Dual-core ARM Cortex-M0+" },
      { label: "Memory", value: "264KB SRAM" },
      { label: "Storage", value: "2MB Flash" },
      { label: "Interface", value: "USB-C" },
      { label: "Dimensions", value: "51mm x 21mm x 7mm" }
    ],
    reviews: [
      { id: "1", author: "CyberHunter", rating: 5, date: "2024-01-15", comment: "Excellent tool for penetration testing. Works flawlessly!" },
      { id: "2", author: "SecPro", rating: 5, date: "2024-01-10", comment: "Great build quality and easy to use. Highly recommended." }
    ]
  },
  {
    id: "all-tdcs-courses",
    ...
    salePrice: 4499,
    isOutOfStock: false,
    description: "Complete bundle of all TDCS cybersecurity courses. Master ethical hacking, penetration testing, bug bounty hunting, and more with lifetime access to all current and future courses.",
    features: [
